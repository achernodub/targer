...
class Evaluator():
    def get_accuracy_token_level(self, targets_idx, outputs_idx):
        y_true = [i for sequence in targets_idx for i in sequence]
        y_pred = [i for sequence in outputs_idx for i in sequence]
        return accuracy_score(y_true, y_pred) * 100

    def get_f1(self, targets_idx, outputs_idx):
        return self.get_accuracy_token_level(targets_idx, outputs_idx)
