...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Learning tagging problem with neural networks')
    ...
    parser.add_argument('--clip_grad', type=float, default=5.0, help='Clipping gradients maximum norm')
    ...
    parser.add_argument('--seed_num', type=int, default=42, help='Seed number')
