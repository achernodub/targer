...
if __name__ == "__main__":
    ...
    parser.add_argument('--load_checkpoint_fn', default='pretrained/tagger_NER_BiLSTMCNNCRF.hdf5', help='Path to load the trained model.')
    ...
    DataIO.write_CoNNL_2003_two_columns(fn='out.txt',
                                        ...
                                        tag_sequences_2=outputs_tag_sequences_test)
    print('\nThe end.')