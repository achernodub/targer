...
class TaggerBiRNN(nn.Module):
    def __init__(self, embeddings_tensor, freeze_embeddings, dropout_ratio, rnn_hidden_size, class_num, rnn_type='LSTM'):
        self.embeddings = torch.nn.Embedding.from_pretrained(embeddings=embeddings_tensor,
